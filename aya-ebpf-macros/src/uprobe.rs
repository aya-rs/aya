...
mod tests {
    ...
    #[test]
    fn test_uprobe_multi_sleepable() {
        let uprobe = UProbe::parse(
            UProbeKind::UProbe,
            parse_quote! {multi, sleepable},
            parse_quote! {
                fn foo(ctx: ProbeContext) -> u32 {
                    0
                }
        ...
        assert_eq!(
            ...
            quote! {
                #[unsafe(no_mangle)]
                #[unsafe(link_section = "uprobe.multi.s")]
                fn foo(ctx: *mut ::core::ffi::c_void) -> u32 {
                    let _ = foo(::aya_ebpf::programs::ProbeContext::new(ctx));
                    return 0;
    ...
    fn test_uretprobe_multi() {
        ...
        assert_eq!(
            ...
            quote! {
                #[unsafe(no_mangle)]
                #[unsafe(link_section = "uretprobe.multi")]
                fn foo(ctx: *mut ::core::ffi::c_void) -> u32 {
                    let _ = foo(::aya_ebpf::programs::RetProbeContext::new(ctx));
                    return 0;
    ...
    #[test]
    fn test_uretprobe_multi_sleepable() {
        let uprobe = UProbe::parse(
            UProbeKind::URetProbe,
            parse_quote! {multi, sleepable},
            parse_quote! {
        ...
        assert_eq!(
            ...
            quote! {
                #[unsafe(no_mangle)]
                #[unsafe(link_section = "uretprobe.multi.s")]
                fn foo(ctx: *mut ::core::ffi::c_void) -> u32 {
                    let _ = foo(::aya_ebpf::programs::RetProbeContext::new(ctx));
                    return 0;
