...
pub unsafe fn bpf_map_lookup_elem(
    ...
    let fun: unsafe extern "C" fn(
        map: *mut core::ffi::c_void,
        key: *const core::ffi::c_void,
    ) -> *mut core::ffi::c_void = ::core::mem::transmute(1usize);
    fun(map, key)
}
pub unsafe fn bpf_map_update_elem(
    ...
    let fun: unsafe extern "C" fn(
        ...
        value: *const core::ffi::c_void,
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(2usize);
...
pub unsafe fn bpf_map_delete_elem(
    ...
    let fun: unsafe extern "C" fn(
        map: *mut core::ffi::c_void,
        key: *const core::ffi::c_void,
    ) -> core::ffi::c_long = ::core::mem::transmute(3usize);
    fun(map, key)
}
pub unsafe fn bpf_probe_read(
    ...
    let fun: unsafe extern "C" fn(
        ...
        size: __u32,
        unsafe_ptr: *const core::ffi::c_void,
    ) -> core::ffi::c_long = ::core::mem::transmute(4usize);
...
pub unsafe fn bpf_skb_store_bytes(
    ...
    let fun: unsafe extern "C" fn(
        ...
        len: __u32,
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(9usize);
...
pub unsafe fn bpf_l3_csum_replace(
    ...
    let fun: unsafe extern "C" fn(
        ...
        to: __u64,
        size: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(10usize);
...
pub unsafe fn bpf_l4_csum_replace(
    ...
    let fun: unsafe extern "C" fn(
        ...
        to: __u64,
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(11usize);
    fun(skb, offset, from, to, flags)
}
pub unsafe fn bpf_tail_call(
    ctx: *mut core::ffi::c_void,
    prog_array_map: *mut core::ffi::c_void,
    index: __u32,
) -> core::ffi::c_long {
    let fun: unsafe extern "C" fn(
        ctx: *mut core::ffi::c_void,
        prog_array_map: *mut core::ffi::c_void,
        index: __u32,
    ) -> core::ffi::c_long = ::core::mem::transmute(12usize);
...
pub unsafe fn bpf_clone_redirect(
    ...
    let fun: unsafe extern "C" fn(
        ...
        ifindex: __u32,
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(13usize);
...
pub unsafe fn bpf_get_current_comm(
    ...
    let fun: unsafe extern "C" fn(
        buf: *mut core::ffi::c_void,
        size_of_buf: __u32,
    ) -> core::ffi::c_long = ::core::mem::transmute(16usize);
    fun(buf, size_of_buf)
}
...
pub unsafe fn bpf_skb_vlan_push(
    ...
    let fun: unsafe extern "C" fn(
        ...
        vlan_proto: __be16,
        vlan_tci: __u16,
    ) -> core::ffi::c_long = ::core::mem::transmute(18usize);
    fun(skb, vlan_proto, vlan_tci)
}
pub unsafe fn bpf_skb_vlan_pop(skb: *mut __sk_buff) -> core::ffi::c_long {
    let fun: unsafe extern "C" fn(skb: *mut __sk_buff) -> core::ffi::c_long =
...
pub unsafe fn bpf_skb_get_tunnel_key(
    ...
    let fun: unsafe extern "C" fn(
        ...
        size: __u32,
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(20usize);
...
pub unsafe fn bpf_skb_set_tunnel_key(
    ...
    let fun: unsafe extern "C" fn(
        ...
        size: __u32,
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(21usize);
    fun(skb, key, size, flags)
}
pub unsafe fn bpf_perf_event_read(map: *mut core::ffi::c_void, flags: __u64) -> __u64 {
    let fun: unsafe extern "C" fn(map: *mut core::ffi::c_void, flags: __u64) -> __u64 =
        ::core::mem::transmute(22usize);
    fun(map, flags)
}
pub unsafe fn bpf_redirect(ifindex: __u32, flags: __u64) -> core::ffi::c_long {
    let fun: unsafe extern "C" fn(ifindex: __u32, flags: __u64) -> core::ffi::c_long =
...
pub unsafe fn bpf_perf_event_output(
    ...
    let fun: unsafe extern "C" fn(
        ...
        data: *mut core::ffi::c_void,
        size: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(25usize);
    fun(ctx, map, flags, data, size)
}
pub unsafe fn bpf_skb_load_bytes(
    skb: *const core::ffi::c_void,
    offset: __u32,
    ...
    let fun: unsafe extern "C" fn(
        ...
        to: *mut core::ffi::c_void,
        len: __u32,
    ) -> core::ffi::c_long = ::core::mem::transmute(26usize);
...
pub unsafe fn bpf_get_stackid(
    ...
    let fun: unsafe extern "C" fn(
        ...
        map: *mut core::ffi::c_void,
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(27usize);
    fun(ctx, map, flags)
}
...
pub unsafe fn bpf_skb_get_tunnel_opt(
    ...
    let fun: unsafe extern "C" fn(
        ...
        opt: *mut core::ffi::c_void,
        size: __u32,
    ) -> core::ffi::c_long = ::core::mem::transmute(29usize);
    fun(skb, opt, size)
}
pub unsafe fn bpf_skb_set_tunnel_opt(
    ...
    let fun: unsafe extern "C" fn(
        ...
        opt: *mut core::ffi::c_void,
        size: __u32,
    ) -> core::ffi::c_long = ::core::mem::transmute(30usize);
    fun(skb, opt, size)
}
pub unsafe fn bpf_skb_change_proto(
    ...
    let fun: unsafe extern "C" fn(
        ...
        proto: __be16,
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(31usize);
    fun(skb, proto, flags)
}
pub unsafe fn bpf_skb_change_type(skb: *mut __sk_buff, type_: __u32) -> core::ffi::c_long {
    let fun: unsafe extern "C" fn(skb: *mut __sk_buff, type_: __u32) -> core::ffi::c_long =
...
pub unsafe fn bpf_skb_under_cgroup(
    ...
    let fun: unsafe extern "C" fn(
        ...
        map: *mut core::ffi::c_void,
        index: __u32,
    ) -> core::ffi::c_long = ::core::mem::transmute(33usize);
    fun(skb, map, index)
}
...
pub unsafe fn bpf_probe_write_user(
    ...
    let fun: unsafe extern "C" fn(
        ...
        src: *const core::ffi::c_void,
        len: __u32,
    ) -> core::ffi::c_long = ::core::mem::transmute(36usize);
    fun(dst, src, len)
}
pub unsafe fn bpf_current_task_under_cgroup(
    ...
    let fun: unsafe extern "C" fn(map: *mut core::ffi::c_void, index: __u32) -> core::ffi::c_long =
        ::core::mem::transmute(37usize);
    fun(map, index)
}
pub unsafe fn bpf_skb_change_tail(
    ...
    let fun: unsafe extern "C" fn(
        ...
        len: __u32,
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(38usize);
    fun(skb, len, flags)
}
pub unsafe fn bpf_skb_pull_data(skb: *mut __sk_buff, len: __u32) -> core::ffi::c_long {
    let fun: unsafe extern "C" fn(skb: *mut __sk_buff, len: __u32) -> core::ffi::c_long =
...
pub unsafe fn bpf_get_numa_node_id() -> core::ffi::c_long {
    let fun: unsafe extern "C" fn() -> core::ffi::c_long = ::core::mem::transmute(42usize);
    fun()
}
pub unsafe fn bpf_skb_change_head(
    ...
    let fun: unsafe extern "C" fn(
        ...
        len: __u32,
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(43usize);
    fun(skb, len, flags)
}
pub unsafe fn bpf_xdp_adjust_head(
    ...
    let fun: unsafe extern "C" fn(
        xdp_md: *mut xdp_md,
        delta: core::ffi::c_int,
    ) -> core::ffi::c_long = ::core::mem::transmute(44usize);
    fun(xdp_md, delta)
}
pub unsafe fn bpf_probe_read_str(
    ...
    let fun: unsafe extern "C" fn(
        ...
        size: __u32,
        unsafe_ptr: *const core::ffi::c_void,
    ) -> core::ffi::c_long = ::core::mem::transmute(45usize);
    fun(dst, size, unsafe_ptr)
}
pub unsafe fn bpf_get_socket_cookie(ctx: *mut core::ffi::c_void) -> __u64 {
    let fun: unsafe extern "C" fn(ctx: *mut core::ffi::c_void) -> __u64 =
...
pub unsafe fn bpf_set_hash(skb: *mut __sk_buff, hash: __u32) -> core::ffi::c_long {
    let fun: unsafe extern "C" fn(skb: *mut __sk_buff, hash: __u32) -> core::ffi::c_long =
        ::core::mem::transmute(48usize);
    fun(skb, hash)
}
pub unsafe fn bpf_setsockopt(
    bpf_socket: *mut core::ffi::c_void,
    ...
    let fun: unsafe extern "C" fn(
        ...
        optval: *mut core::ffi::c_void,
        optlen: core::ffi::c_int,
    ) -> core::ffi::c_long = ::core::mem::transmute(49usize);
...
pub unsafe fn bpf_skb_adjust_room(
    ...
    let fun: unsafe extern "C" fn(
        ...
        mode: __u32,
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(50usize);
...
pub unsafe fn bpf_redirect_map(
    ...
    let fun: unsafe extern "C" fn(
        ...
        key: __u64,
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(51usize);
    fun(map, key, flags)
}
pub unsafe fn bpf_sk_redirect_map(
    ...
    let fun: unsafe extern "C" fn(
        ...
        key: __u32,
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(52usize);
...
pub unsafe fn bpf_sock_map_update(
    ...
    let fun: unsafe extern "C" fn(
        ...
        key: *mut core::ffi::c_void,
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(53usize);
...
pub unsafe fn bpf_xdp_adjust_meta(
    ...
    let fun: unsafe extern "C" fn(
        xdp_md: *mut xdp_md,
        delta: core::ffi::c_int,
    ) -> core::ffi::c_long = ::core::mem::transmute(54usize);
    fun(xdp_md, delta)
}
pub unsafe fn bpf_perf_event_read_value(
    ...
    let fun: unsafe extern "C" fn(
        ...
        buf: *mut bpf_perf_event_value,
        buf_size: __u32,
    ) -> core::ffi::c_long = ::core::mem::transmute(55usize);
...
pub unsafe fn bpf_perf_prog_read_value(
    ...
    let fun: unsafe extern "C" fn(
        ...
        buf: *mut bpf_perf_event_value,
        buf_size: __u32,
    ) -> core::ffi::c_long = ::core::mem::transmute(56usize);
...
pub unsafe fn bpf_getsockopt(
    ...
    let fun: unsafe extern "C" fn(
        ...
        optval: *mut core::ffi::c_void,
        optlen: core::ffi::c_int,
    ) -> core::ffi::c_long = ::core::mem::transmute(57usize);
    fun(bpf_socket, level, optname, optval, optlen)
}
pub unsafe fn bpf_override_return(regs: *mut pt_regs, rc: __u64) -> core::ffi::c_long {
    let fun: unsafe extern "C" fn(regs: *mut pt_regs, rc: __u64) -> core::ffi::c_long =
        ::core::mem::transmute(58usize);
    fun(regs, rc)
}
pub unsafe fn bpf_sock_ops_cb_flags_set(
    bpf_sock: *mut bpf_sock_ops,
    argval: core::ffi::c_int,
) -> core::ffi::c_long {
    let fun: unsafe extern "C" fn(
        bpf_sock: *mut bpf_sock_ops,
        argval: core::ffi::c_int,
    ) -> core::ffi::c_long = ::core::mem::transmute(59usize);
    fun(bpf_sock, argval)
}
pub unsafe fn bpf_msg_redirect_map(
    ...
    let fun: unsafe extern "C" fn(
        ...
        key: __u32,
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(60usize);
    fun(msg, map, key, flags)
}
pub unsafe fn bpf_msg_apply_bytes(msg: *mut sk_msg_md, bytes: __u32) -> core::ffi::c_long {
    let fun: unsafe extern "C" fn(msg: *mut sk_msg_md, bytes: __u32) -> core::ffi::c_long =
        ::core::mem::transmute(61usize);
    fun(msg, bytes)
}
pub unsafe fn bpf_msg_cork_bytes(msg: *mut sk_msg_md, bytes: __u32) -> core::ffi::c_long {
    let fun: unsafe extern "C" fn(msg: *mut sk_msg_md, bytes: __u32) -> core::ffi::c_long =
...
pub unsafe fn bpf_msg_pull_data(
    ...
    let fun: unsafe extern "C" fn(
        ...
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(63usize);
...
pub unsafe fn bpf_bind(
    ...
    let fun: unsafe extern "C" fn(
        ...
        addr: *mut sockaddr,
        addr_len: core::ffi::c_int,
    ) -> core::ffi::c_long = ::core::mem::transmute(64usize);
...
pub unsafe fn bpf_xdp_adjust_tail(
    ...
    let fun: unsafe extern "C" fn(
        xdp_md: *mut xdp_md,
        delta: core::ffi::c_int,
    ) -> core::ffi::c_long = ::core::mem::transmute(65usize);
    fun(xdp_md, delta)
}
pub unsafe fn bpf_skb_get_xfrm_state(
    ...
    let fun: unsafe extern "C" fn(
        ...
        size: __u32,
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(66usize);
...
pub unsafe fn bpf_get_stack(
    ...
    let fun: unsafe extern "C" fn(
        ...
        size: __u32,
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(67usize);
...
pub unsafe fn bpf_skb_load_bytes_relative(
    ...
    let fun: unsafe extern "C" fn(
        ...
        len: __u32,
        start_header: __u32,
    ) -> core::ffi::c_long = ::core::mem::transmute(68usize);
...
pub unsafe fn bpf_fib_lookup(
    ...
    let fun: unsafe extern "C" fn(
        ...
        plen: core::ffi::c_int,
        flags: __u32,
    ) -> core::ffi::c_long = ::core::mem::transmute(69usize);
...
pub unsafe fn bpf_sock_hash_update(
    ...
    let fun: unsafe extern "C" fn(
        ...
        key: *mut core::ffi::c_void,
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(70usize);
    fun(skops, map, key, flags)
}
pub unsafe fn bpf_msg_redirect_hash(
    ...
    let fun: unsafe extern "C" fn(
        ...
        key: *mut core::ffi::c_void,
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(71usize);
    fun(msg, map, key, flags)
}
pub unsafe fn bpf_sk_redirect_hash(
    ...
    let fun: unsafe extern "C" fn(
        ...
        key: *mut core::ffi::c_void,
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(72usize);
    fun(skb, map, key, flags)
}
pub unsafe fn bpf_lwt_push_encap(
    ...
    let fun: unsafe extern "C" fn(
        ...
        hdr: *mut core::ffi::c_void,
        len: __u32,
    ) -> core::ffi::c_long = ::core::mem::transmute(73usize);
...
pub unsafe fn bpf_lwt_seg6_store_bytes(
    ...
    let fun: unsafe extern "C" fn(
        ...
        from: *const core::ffi::c_void,
        len: __u32,
    ) -> core::ffi::c_long = ::core::mem::transmute(74usize);
...
pub unsafe fn bpf_lwt_seg6_adjust_srh(
    ...
    let fun: unsafe extern "C" fn(
        ...
        offset: __u32,
        delta: __s32,
    ) -> core::ffi::c_long = ::core::mem::transmute(75usize);
...
pub unsafe fn bpf_lwt_seg6_action(
    ...
    let fun: unsafe extern "C" fn(
        ...
        param: *mut core::ffi::c_void,
        param_len: __u32,
    ) -> core::ffi::c_long = ::core::mem::transmute(76usize);
    fun(skb, action, param, param_len)
}
pub unsafe fn bpf_rc_repeat(ctx: *mut core::ffi::c_void) -> core::ffi::c_long {
    let fun: unsafe extern "C" fn(ctx: *mut core::ffi::c_void) -> core::ffi::c_long =
...
pub unsafe fn bpf_rc_keydown(
    ...
    let fun: unsafe extern "C" fn(
        ...
        scancode: __u64,
        toggle: __u32,
    ) -> core::ffi::c_long = ::core::mem::transmute(78usize);
...
pub unsafe fn bpf_get_local_storage(
    ...
    let fun: unsafe extern "C" fn(
        map: *mut core::ffi::c_void,
        flags: __u64,
    ) -> *mut core::ffi::c_void = ::core::mem::transmute(81usize);
    fun(map, flags)
}
pub unsafe fn bpf_sk_select_reuseport(
    ...
    let fun: unsafe extern "C" fn(
        ...
        key: *mut core::ffi::c_void,
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(82usize);
    fun(reuse, map, key, flags)
}
pub unsafe fn bpf_skb_ancestor_cgroup_id(
    skb: *mut __sk_buff,
    ancestor_level: core::ffi::c_int,
) -> __u64 {
    let fun: unsafe extern "C" fn(skb: *mut __sk_buff, ancestor_level: core::ffi::c_int) -> __u64 =
        ::core::mem::transmute(83usize);
...
pub unsafe fn bpf_sk_release(sock: *mut core::ffi::c_void) -> core::ffi::c_long {
    let fun: unsafe extern "C" fn(sock: *mut core::ffi::c_void) -> core::ffi::c_long =
...
pub unsafe fn bpf_map_push_elem(
    ...
    let fun: unsafe extern "C" fn(
        ...
        value: *const core::ffi::c_void,
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(87usize);
    fun(map, value, flags)
}
pub unsafe fn bpf_map_pop_elem(
    ...
    let fun: unsafe extern "C" fn(
        map: *mut core::ffi::c_void,
        value: *mut core::ffi::c_void,
    ) -> core::ffi::c_long = ::core::mem::transmute(88usize);
    fun(map, value)
}
pub unsafe fn bpf_map_peek_elem(
    ...
    let fun: unsafe extern "C" fn(
        map: *mut core::ffi::c_void,
        value: *mut core::ffi::c_void,
    ) -> core::ffi::c_long = ::core::mem::transmute(89usize);
    fun(map, value)
}
pub unsafe fn bpf_msg_push_data(
    ...
    let fun: unsafe extern "C" fn(
        ...
        len: __u32,
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(90usize);
...
pub unsafe fn bpf_msg_pop_data(
    ...
    let fun: unsafe extern "C" fn(
        ...
        len: __u32,
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(91usize);
    fun(msg, start, len, flags)
}
pub unsafe fn bpf_rc_pointer_rel(
    ...
    let fun: unsafe extern "C" fn(
        ...
        rel_x: __s32,
        rel_y: __s32,
    ) -> core::ffi::c_long = ::core::mem::transmute(92usize);
    fun(ctx, rel_x, rel_y)
}
pub unsafe fn bpf_spin_lock(lock: *mut bpf_spin_lock) -> core::ffi::c_long {
    let fun: unsafe extern "C" fn(lock: *mut bpf_spin_lock) -> core::ffi::c_long =
        ::core::mem::transmute(93usize);
    fun(lock)
}
pub unsafe fn bpf_spin_unlock(lock: *mut bpf_spin_lock) -> core::ffi::c_long {
    let fun: unsafe extern "C" fn(lock: *mut bpf_spin_lock) -> core::ffi::c_long =
...
pub unsafe fn bpf_skb_ecn_set_ce(skb: *mut __sk_buff) -> core::ffi::c_long {
    let fun: unsafe extern "C" fn(skb: *mut __sk_buff) -> core::ffi::c_long =
...
pub unsafe fn bpf_tcp_check_syncookie(
    ...
    let fun: unsafe extern "C" fn(
        ...
        th: *mut tcphdr,
        th_len: __u32,
    ) -> core::ffi::c_long = ::core::mem::transmute(100usize);
...
pub unsafe fn bpf_sysctl_get_name(
    ...
    let fun: unsafe extern "C" fn(
        ...
        buf_len: core::ffi::c_ulong,
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(101usize);
...
pub unsafe fn bpf_sysctl_get_current_value(
    ...
    let fun: unsafe extern "C" fn(
        ...
        buf: *mut core::ffi::c_char,
        buf_len: core::ffi::c_ulong,
    ) -> core::ffi::c_long = ::core::mem::transmute(102usize);
    fun(ctx, buf, buf_len)
}
pub unsafe fn bpf_sysctl_get_new_value(
    ...
    let fun: unsafe extern "C" fn(
        ...
        buf: *mut core::ffi::c_char,
        buf_len: core::ffi::c_ulong,
    ) -> core::ffi::c_long = ::core::mem::transmute(103usize);
    fun(ctx, buf, buf_len)
}
pub unsafe fn bpf_sysctl_set_new_value(
    ...
    let fun: unsafe extern "C" fn(
        ...
        buf: *const core::ffi::c_char,
        buf_len: core::ffi::c_ulong,
    ) -> core::ffi::c_long = ::core::mem::transmute(104usize);
    fun(ctx, buf, buf_len)
}
pub unsafe fn bpf_strtol(
    ...
    let fun: unsafe extern "C" fn(
        ...
        flags: __u64,
        res: *mut core::ffi::c_long,
    ) -> core::ffi::c_long = ::core::mem::transmute(105usize);
...
pub unsafe fn bpf_strtoul(
    ...
    let fun: unsafe extern "C" fn(
        ...
        flags: __u64,
        res: *mut core::ffi::c_ulong,
    ) -> core::ffi::c_long = ::core::mem::transmute(106usize);
    fun(buf, buf_len, flags, res)
}
pub unsafe fn bpf_sk_storage_get(
    ...
    let fun: unsafe extern "C" fn(
        ...
        value: *mut core::ffi::c_void,
        flags: __u64,
    ) -> *mut core::ffi::c_void = ::core::mem::transmute(107usize);
...
pub unsafe fn bpf_sk_storage_delete(
    ...
    let fun: unsafe extern "C" fn(
        map: *mut core::ffi::c_void,
        sk: *mut core::ffi::c_void,
    ) -> core::ffi::c_long = ::core::mem::transmute(108usize);
    fun(map, sk)
}
pub unsafe fn bpf_send_signal(sig: __u32) -> core::ffi::c_long {
    let fun: unsafe extern "C" fn(sig: __u32) -> core::ffi::c_long =
...
pub unsafe fn bpf_skb_output(
    ...
    let fun: unsafe extern "C" fn(
        ...
        data: *mut core::ffi::c_void,
        size: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(111usize);
    fun(ctx, map, flags, data, size)
}
pub unsafe fn bpf_probe_read_user(
    ...
    let fun: unsafe extern "C" fn(
        ...
        size: __u32,
        unsafe_ptr: *const core::ffi::c_void,
    ) -> core::ffi::c_long = ::core::mem::transmute(112usize);
    fun(dst, size, unsafe_ptr)
}
pub unsafe fn bpf_probe_read_kernel(
    ...
    let fun: unsafe extern "C" fn(
        ...
        size: __u32,
        unsafe_ptr: *const core::ffi::c_void,
    ) -> core::ffi::c_long = ::core::mem::transmute(113usize);
    fun(dst, size, unsafe_ptr)
}
pub unsafe fn bpf_probe_read_user_str(
    ...
    let fun: unsafe extern "C" fn(
        ...
        size: __u32,
        unsafe_ptr: *const core::ffi::c_void,
    ) -> core::ffi::c_long = ::core::mem::transmute(114usize);
    fun(dst, size, unsafe_ptr)
}
pub unsafe fn bpf_probe_read_kernel_str(
    ...
    let fun: unsafe extern "C" fn(
        ...
        size: __u32,
        unsafe_ptr: *const core::ffi::c_void,
    ) -> core::ffi::c_long = ::core::mem::transmute(115usize);
    fun(dst, size, unsafe_ptr)
}
pub unsafe fn bpf_tcp_send_ack(tp: *mut core::ffi::c_void, rcv_nxt: __u32) -> core::ffi::c_long {
    let fun: unsafe extern "C" fn(tp: *mut core::ffi::c_void, rcv_nxt: __u32) -> core::ffi::c_long =
        ::core::mem::transmute(116usize);
    fun(tp, rcv_nxt)
}
pub unsafe fn bpf_send_signal_thread(sig: __u32) -> core::ffi::c_long {
    let fun: unsafe extern "C" fn(sig: __u32) -> core::ffi::c_long =
...
pub unsafe fn bpf_read_branch_records(
    ...
    let fun: unsafe extern "C" fn(
        ...
        size: __u32,
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(119usize);
    fun(ctx, buf, size, flags)
}
pub unsafe fn bpf_get_ns_current_pid_tgid(
    ...
    let fun: unsafe extern "C" fn(
        ...
        nsdata: *mut bpf_pidns_info,
        size: __u32,
    ) -> core::ffi::c_long = ::core::mem::transmute(120usize);
...
pub unsafe fn bpf_xdp_output(
    ...
    let fun: unsafe extern "C" fn(
        ...
        data: *mut core::ffi::c_void,
        size: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(121usize);
    fun(ctx, map, flags, data, size)
}
pub unsafe fn bpf_get_netns_cookie(ctx: *mut core::ffi::c_void) -> __u64 {
    let fun: unsafe extern "C" fn(ctx: *mut core::ffi::c_void) -> __u64 =
        ::core::mem::transmute(122usize);
    fun(ctx)
}
pub unsafe fn bpf_get_current_ancestor_cgroup_id(ancestor_level: core::ffi::c_int) -> __u64 {
    let fun: unsafe extern "C" fn(ancestor_level: core::ffi::c_int) -> __u64 =
...
pub unsafe fn bpf_sk_assign(
    ...
    let fun: unsafe extern "C" fn(
        ...
        sk: *mut core::ffi::c_void,
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(124usize);
    fun(ctx, sk, flags)
}
...
pub unsafe fn bpf_seq_printf(
    ...
    let fun: unsafe extern "C" fn(
        ...
        data: *const core::ffi::c_void,
        data_len: __u32,
    ) -> core::ffi::c_long = ::core::mem::transmute(126usize);
...
pub unsafe fn bpf_seq_write(
    ...
    let fun: unsafe extern "C" fn(
        ...
        data: *const core::ffi::c_void,
        len: __u32,
    ) -> core::ffi::c_long = ::core::mem::transmute(127usize);
    fun(m, data, len)
}
pub unsafe fn bpf_sk_cgroup_id(sk: *mut core::ffi::c_void) -> __u64 {
    let fun: unsafe extern "C" fn(sk: *mut core::ffi::c_void) -> __u64 =
...
pub unsafe fn bpf_ringbuf_output(
    ...
    let fun: unsafe extern "C" fn(
        ...
        size: __u64,
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(130usize);
...
pub unsafe fn bpf_ringbuf_reserve(
    ...
    let fun: unsafe extern "C" fn(
        ...
        size: __u64,
        flags: __u64,
    ) -> *mut core::ffi::c_void = ::core::mem::transmute(131usize);
    fun(ringbuf, size, flags)
}
pub unsafe fn bpf_ringbuf_submit(data: *mut core::ffi::c_void, flags: __u64) {
    let fun: unsafe extern "C" fn(data: *mut core::ffi::c_void, flags: __u64) =
        ::core::mem::transmute(132usize);
    fun(data, flags)
}
pub unsafe fn bpf_ringbuf_discard(data: *mut core::ffi::c_void, flags: __u64) {
    let fun: unsafe extern "C" fn(data: *mut core::ffi::c_void, flags: __u64) =
        ::core::mem::transmute(133usize);
    fun(data, flags)
}
pub unsafe fn bpf_ringbuf_query(ringbuf: *mut core::ffi::c_void, flags: __u64) -> __u64 {
    let fun: unsafe extern "C" fn(ringbuf: *mut core::ffi::c_void, flags: __u64) -> __u64 =
        ::core::mem::transmute(134usize);
    fun(ringbuf, flags)
}
pub unsafe fn bpf_csum_level(skb: *mut __sk_buff, level: __u64) -> core::ffi::c_long {
    let fun: unsafe extern "C" fn(skb: *mut __sk_buff, level: __u64) -> core::ffi::c_long =
        ::core::mem::transmute(135usize);
    fun(skb, level)
}
pub unsafe fn bpf_skc_to_tcp6_sock(sk: *mut core::ffi::c_void) -> *mut tcp6_sock {
    let fun: unsafe extern "C" fn(sk: *mut core::ffi::c_void) -> *mut tcp6_sock =
        ::core::mem::transmute(136usize);
    fun(sk)
}
pub unsafe fn bpf_skc_to_tcp_sock(sk: *mut core::ffi::c_void) -> *mut tcp_sock {
    let fun: unsafe extern "C" fn(sk: *mut core::ffi::c_void) -> *mut tcp_sock =
        ::core::mem::transmute(137usize);
    fun(sk)
}
pub unsafe fn bpf_skc_to_tcp_timewait_sock(sk: *mut core::ffi::c_void) -> *mut tcp_timewait_sock {
    let fun: unsafe extern "C" fn(sk: *mut core::ffi::c_void) -> *mut tcp_timewait_sock =
        ::core::mem::transmute(138usize);
    fun(sk)
}
pub unsafe fn bpf_skc_to_tcp_request_sock(sk: *mut core::ffi::c_void) -> *mut tcp_request_sock {
    let fun: unsafe extern "C" fn(sk: *mut core::ffi::c_void) -> *mut tcp_request_sock =
        ::core::mem::transmute(139usize);
    fun(sk)
}
pub unsafe fn bpf_skc_to_udp6_sock(sk: *mut core::ffi::c_void) -> *mut udp6_sock {
    let fun: unsafe extern "C" fn(sk: *mut core::ffi::c_void) -> *mut udp6_sock =
...
pub unsafe fn bpf_get_task_stack(
    ...
    let fun: unsafe extern "C" fn(
        ...
        size: __u32,
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(141usize);
...
pub unsafe fn bpf_load_hdr_opt(
    ...
    let fun: unsafe extern "C" fn(
        ...
        len: __u32,
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(142usize);
...
pub unsafe fn bpf_store_hdr_opt(
    ...
    let fun: unsafe extern "C" fn(
        ...
        len: __u32,
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(143usize);
...
pub unsafe fn bpf_reserve_hdr_opt(
    ...
    let fun: unsafe extern "C" fn(
        ...
        len: __u32,
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(144usize);
    fun(skops, len, flags)
}
pub unsafe fn bpf_inode_storage_get(
    ...
    let fun: unsafe extern "C" fn(
        ...
        value: *mut core::ffi::c_void,
        flags: __u64,
    ) -> *mut core::ffi::c_void = ::core::mem::transmute(145usize);
...
pub unsafe fn bpf_inode_storage_delete(
    ...
    let fun: unsafe extern "C" fn(
        map: *mut core::ffi::c_void,
        inode: *mut core::ffi::c_void,
    ) -> core::ffi::c_int = ::core::mem::transmute(146usize);
    fun(map, inode)
}
pub unsafe fn bpf_d_path(
    ...
    let fun: unsafe extern "C" fn(
        ...
        buf: *mut core::ffi::c_char,
        sz: __u32,
    ) -> core::ffi::c_long = ::core::mem::transmute(147usize);
    fun(path, buf, sz)
}
pub unsafe fn bpf_copy_from_user(
    ...
    let fun: unsafe extern "C" fn(
        ...
        size: __u32,
        user_ptr: *const core::ffi::c_void,
    ) -> core::ffi::c_long = ::core::mem::transmute(148usize);
...
pub unsafe fn bpf_snprintf_btf(
    ...
    let fun: unsafe extern "C" fn(
        ...
        btf_ptr_size: __u32,
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(149usize);
...
pub unsafe fn bpf_seq_printf_btf(
    ...
    let fun: unsafe extern "C" fn(
        ...
        ptr_size: __u32,
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(150usize);
...
pub unsafe fn bpf_redirect_neigh(
    ...
    let fun: unsafe extern "C" fn(
        ...
        plen: core::ffi::c_int,
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(152usize);
    fun(ifindex, params, plen, flags)
}
pub unsafe fn bpf_per_cpu_ptr(
    percpu_ptr: *const core::ffi::c_void,
    cpu: __u32,
) -> *mut core::ffi::c_void {
    let fun: unsafe extern "C" fn(
        percpu_ptr: *const core::ffi::c_void,
        cpu: __u32,
    ) -> *mut core::ffi::c_void = ::core::mem::transmute(153usize);
    fun(percpu_ptr, cpu)
}
pub unsafe fn bpf_this_cpu_ptr(percpu_ptr: *const core::ffi::c_void) -> *mut core::ffi::c_void {
    let fun: unsafe extern "C" fn(percpu_ptr: *const core::ffi::c_void) -> *mut core::ffi::c_void =
        ::core::mem::transmute(154usize);
    fun(percpu_ptr)
}
pub unsafe fn bpf_redirect_peer(ifindex: __u32, flags: __u64) -> core::ffi::c_long {
    let fun: unsafe extern "C" fn(ifindex: __u32, flags: __u64) -> core::ffi::c_long =
...
pub unsafe fn bpf_task_storage_get(
    ...
    let fun: unsafe extern "C" fn(
        ...
        value: *mut core::ffi::c_void,
        flags: __u64,
    ) -> *mut core::ffi::c_void = ::core::mem::transmute(156usize);
...
pub unsafe fn bpf_task_storage_delete(
    ...
    let fun: unsafe extern "C" fn(
        map: *mut core::ffi::c_void,
        task: *mut task_struct,
    ) -> core::ffi::c_long = ::core::mem::transmute(157usize);
    fun(map, task)
}
...
pub unsafe fn bpf_bprm_opts_set(bprm: *mut linux_binprm, flags: __u64) -> core::ffi::c_long {
    let fun: unsafe extern "C" fn(bprm: *mut linux_binprm, flags: __u64) -> core::ffi::c_long =
...
pub unsafe fn bpf_ima_inode_hash(
    ...
    let fun: unsafe extern "C" fn(
        ...
        dst: *mut core::ffi::c_void,
        size: __u32,
    ) -> core::ffi::c_long = ::core::mem::transmute(161usize);
    fun(inode, dst, size)
}
...
pub unsafe fn bpf_check_mtu(
    ...
    let fun: unsafe extern "C" fn(
        ...
        len_diff: __s32,
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(163usize);
...
pub unsafe fn bpf_for_each_map_elem(
    ...
    let fun: unsafe extern "C" fn(
        ...
        callback_ctx: *mut core::ffi::c_void,
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(164usize);
...
pub unsafe fn bpf_snprintf(
    ...
    let fun: unsafe extern "C" fn(
        ...
        data: *mut __u64,
        data_len: __u32,
    ) -> core::ffi::c_long = ::core::mem::transmute(165usize);
...
pub unsafe fn bpf_sys_bpf(
    ...
    let fun: unsafe extern "C" fn(
        ...
        attr: *mut core::ffi::c_void,
        attr_size: __u32,
    ) -> core::ffi::c_long = ::core::mem::transmute(166usize);
    fun(cmd, attr, attr_size)
}
pub unsafe fn bpf_btf_find_by_name_kind(
    name: *mut core::ffi::c_char,
    name_sz: core::ffi::c_int,
    kind: __u32,
    ...
    let fun: unsafe extern "C" fn(
        ...
        kind: __u32,
        flags: core::ffi::c_int,
    ) -> core::ffi::c_long = ::core::mem::transmute(167usize);
    fun(name, name_sz, kind, flags)
}
pub unsafe fn bpf_sys_close(fd: __u32) -> core::ffi::c_long {
    let fun: unsafe extern "C" fn(fd: __u32) -> core::ffi::c_long =
...
pub unsafe fn bpf_timer_init(
    ...
    let fun: unsafe extern "C" fn(
        ...
        map: *mut core::ffi::c_void,
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(169usize);
    fun(timer, map, flags)
}
pub unsafe fn bpf_timer_set_callback(
    ...
    let fun: unsafe extern "C" fn(
        timer: *mut bpf_timer,
        callback_fn: *mut core::ffi::c_void,
    ) -> core::ffi::c_long = ::core::mem::transmute(170usize);
...
pub unsafe fn bpf_timer_start(
    ...
    let fun: unsafe extern "C" fn(
        ...
        nsecs: __u64,
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(171usize);
    fun(timer, nsecs, flags)
}
pub unsafe fn bpf_timer_cancel(timer: *mut bpf_timer) -> core::ffi::c_long {
    let fun: unsafe extern "C" fn(timer: *mut bpf_timer) -> core::ffi::c_long =
        ::core::mem::transmute(172usize);
    fun(timer)
}
pub unsafe fn bpf_get_func_ip(ctx: *mut core::ffi::c_void) -> __u64 {
    let fun: unsafe extern "C" fn(ctx: *mut core::ffi::c_void) -> __u64 =
        ::core::mem::transmute(173usize);
    fun(ctx)
}
pub unsafe fn bpf_get_attach_cookie(ctx: *mut core::ffi::c_void) -> __u64 {
    let fun: unsafe extern "C" fn(ctx: *mut core::ffi::c_void) -> __u64 =
        ::core::mem::transmute(174usize);
    fun(ctx)
}
pub unsafe fn bpf_task_pt_regs(task: *mut task_struct) -> core::ffi::c_long {
    let fun: unsafe extern "C" fn(task: *mut task_struct) -> core::ffi::c_long =
        ::core::mem::transmute(175usize);
    fun(task)
}
pub unsafe fn bpf_get_branch_snapshot(
    entries: *mut core::ffi::c_void,
    size: __u32,
    flags: __u64,
) -> core::ffi::c_long {
    let fun: unsafe extern "C" fn(
        ...
        size: __u32,
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(176usize);
...
pub unsafe fn bpf_trace_vprintk(
    ...
    let fun: unsafe extern "C" fn(
        ...
        data: *const core::ffi::c_void,
        data_len: __u32,
    ) -> core::ffi::c_long = ::core::mem::transmute(177usize);
    fun(fmt, fmt_size, data, data_len)
}
pub unsafe fn bpf_skc_to_unix_sock(sk: *mut core::ffi::c_void) -> *mut unix_sock {
    let fun: unsafe extern "C" fn(sk: *mut core::ffi::c_void) -> *mut unix_sock =
...
pub unsafe fn bpf_kallsyms_lookup_name(
    ...
    let fun: unsafe extern "C" fn(
        ...
        flags: core::ffi::c_int,
        res: *mut __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(179usize);
...
pub unsafe fn bpf_find_vma(
    ...
    let fun: unsafe extern "C" fn(
        ...
        callback_ctx: *mut core::ffi::c_void,
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(180usize);
...
pub unsafe fn bpf_loop(
    ...
    let fun: unsafe extern "C" fn(
        ...
        callback_ctx: *mut core::ffi::c_void,
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(181usize);
...
pub unsafe fn bpf_strncmp(
    ...
    let fun: unsafe extern "C" fn(
        ...
        s1_sz: __u32,
        s2: *const core::ffi::c_char,
    ) -> core::ffi::c_long = ::core::mem::transmute(182usize);
    fun(s1, s1_sz, s2)
}
pub unsafe fn bpf_get_func_arg(
    ...
    let fun: unsafe extern "C" fn(
        ...
        n: __u32,
        value: *mut __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(183usize);
    fun(ctx, n, value)
}
pub unsafe fn bpf_get_func_ret(
    ...
    let fun: unsafe extern "C" fn(
        ctx: *mut core::ffi::c_void,
        value: *mut __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(184usize);
    fun(ctx, value)
}
pub unsafe fn bpf_get_func_arg_cnt(ctx: *mut core::ffi::c_void) -> core::ffi::c_long {
    let fun: unsafe extern "C" fn(ctx: *mut core::ffi::c_void) -> core::ffi::c_long =
        ::core::mem::transmute(185usize);
    fun(ctx)
}
pub unsafe fn bpf_get_retval() -> core::ffi::c_int {
    let fun: unsafe extern "C" fn() -> core::ffi::c_int = ::core::mem::transmute(186usize);
    fun()
}
pub unsafe fn bpf_set_retval(retval: core::ffi::c_int) -> core::ffi::c_int {
    let fun: unsafe extern "C" fn(retval: core::ffi::c_int) -> core::ffi::c_int =
...
pub unsafe fn bpf_xdp_load_bytes(
    ...
    let fun: unsafe extern "C" fn(
        ...
        buf: *mut core::ffi::c_void,
        len: __u32,
    ) -> core::ffi::c_long = ::core::mem::transmute(189usize);
...
pub unsafe fn bpf_xdp_store_bytes(
    ...
    let fun: unsafe extern "C" fn(
        ...
        buf: *mut core::ffi::c_void,
        len: __u32,
    ) -> core::ffi::c_long = ::core::mem::transmute(190usize);
    fun(xdp_md, offset, buf, len)
}
pub unsafe fn bpf_copy_from_user_task(
    ...
    let fun: unsafe extern "C" fn(
        ...
        tsk: *mut task_struct,
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(191usize);
...
pub unsafe fn bpf_skb_set_tstamp(
    ...
    let fun: unsafe extern "C" fn(
        ...
        tstamp: __u64,
        tstamp_type: __u32,
    ) -> core::ffi::c_long = ::core::mem::transmute(192usize);
...
pub unsafe fn bpf_ima_file_hash(
    ...
    let fun: unsafe extern "C" fn(
        ...
        dst: *mut core::ffi::c_void,
        size: __u32,
    ) -> core::ffi::c_long = ::core::mem::transmute(193usize);
    fun(file, dst, size)
}
pub unsafe fn bpf_kptr_xchg(
    map_value: *mut core::ffi::c_void,
    ptr: *mut core::ffi::c_void,
) -> *mut core::ffi::c_void {
    let fun: unsafe extern "C" fn(
        map_value: *mut core::ffi::c_void,
        ptr: *mut core::ffi::c_void,
    ) -> *mut core::ffi::c_void = ::core::mem::transmute(194usize);
    fun(map_value, ptr)
}
pub unsafe fn bpf_map_lookup_percpu_elem(
    ...
    let fun: unsafe extern "C" fn(
        ...
        key: *const core::ffi::c_void,
        cpu: __u32,
    ) -> *mut core::ffi::c_void = ::core::mem::transmute(195usize);
    fun(map, key, cpu)
}
pub unsafe fn bpf_skc_to_mptcp_sock(sk: *mut core::ffi::c_void) -> *mut mptcp_sock {
    let fun: unsafe extern "C" fn(sk: *mut core::ffi::c_void) -> *mut mptcp_sock =
...
pub unsafe fn bpf_dynptr_from_mem(
    ...
    let fun: unsafe extern "C" fn(
        ...
        flags: __u64,
        ptr: *mut bpf_dynptr,
    ) -> core::ffi::c_long = ::core::mem::transmute(197usize);
...
pub unsafe fn bpf_ringbuf_reserve_dynptr(
    ...
    let fun: unsafe extern "C" fn(
        ...
        flags: __u64,
        ptr: *mut bpf_dynptr,
    ) -> core::ffi::c_long = ::core::mem::transmute(198usize);
...
pub unsafe fn bpf_dynptr_read(
    ...
    let fun: unsafe extern "C" fn(
        ...
        offset: __u32,
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(201usize);
...
pub unsafe fn bpf_dynptr_write(
    ...
    let fun: unsafe extern "C" fn(
        ...
        len: __u32,
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(202usize);
...
pub unsafe fn bpf_dynptr_data(
    ...
    let fun: unsafe extern "C" fn(
        ...
        offset: __u32,
        len: __u32,
    ) -> *mut core::ffi::c_void = ::core::mem::transmute(203usize);
    fun(ptr, offset, len)
}
...
pub unsafe fn bpf_tcp_raw_check_syncookie_ipv4(
    ...
    let fun: unsafe extern "C" fn(iph: *mut iphdr, th: *mut tcphdr) -> core::ffi::c_long =
...
pub unsafe fn bpf_tcp_raw_check_syncookie_ipv6(
    ...
    let fun: unsafe extern "C" fn(iph: *mut ipv6hdr, th: *mut tcphdr) -> core::ffi::c_long =
...
pub unsafe fn bpf_user_ringbuf_drain(
    ...
    let fun: unsafe extern "C" fn(
        ...
        ctx: *mut core::ffi::c_void,
        flags: __u64,
    ) -> core::ffi::c_long = ::core::mem::transmute(209usize);
...
pub unsafe fn bpf_cgrp_storage_get(
    ...
    let fun: unsafe extern "C" fn(
        ...
        value: *mut core::ffi::c_void,
        flags: __u64,
    ) -> *mut core::ffi::c_void = ::core::mem::transmute(210usize);
...
pub unsafe fn bpf_cgrp_storage_delete(
    ...
    let fun: unsafe extern "C" fn(
        map: *mut core::ffi::c_void,
        cgroup: *mut cgroup,
    ) -> core::ffi::c_long = ::core::mem::transmute(211usize);
    fun(map, cgroup)
}
