...
impl<K, V> HashMap<K, V> {
    ...
    const fn new(max_entries: u32, flags: u32, pinning: PinningType) -> Self {
        Self {
            def: MapDef::new::<K, V>(BPF_MAP_TYPE_HASH, max_entries, flags, pinning),
            _kv: PhantomData,
        }
    }
...
impl<K, V> LruHashMap<K, V> {
    ...
    const fn new(max_entries: u32, flags: u32, pinning: PinningType) -> Self {
        Self {
            def: MapDef::new::<K, V>(BPF_MAP_TYPE_LRU_HASH, max_entries, flags, pinning),
            _kv: PhantomData,
        }
    }
...
impl<K, V> PerCpuHashMap<K, V> {
    ...
    const fn new(max_entries: u32, flags: u32, pinning: PinningType) -> Self {
        Self {
            def: MapDef::new::<K, V>(BPF_MAP_TYPE_PERCPU_HASH, max_entries, flags, pinning),
            _kv: PhantomData,
        }
    }
...
impl<K, V> LruPerCpuHashMap<K, V> {
    ...
    const fn new(max_entries: u32, flags: u32, pinning: PinningType) -> Self {
        Self {
            def: MapDef::new::<K, V>(BPF_MAP_TYPE_LRU_PERCPU_HASH, max_entries, flags, pinning),
            _kv: PhantomData,
        }
    }
