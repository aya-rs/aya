...
impl PtRegsLayout for pt_regs {
    ...
    fn arg_reg(&self, index: usize) -> Option<&Self::Reg> {
        ...
        // https://github.com/torvalds/linux/blob/6063257da111c7639d020c5f15bfb37fb839d8b6/arch/arm64/include/uapi/asm/ptrace.h#L88-L93
        // https://github.com/torvalds/linux/blob/6063257da111c7639d020c5f15bfb37fb839d8b6/tools/lib/bpf/bpf_tracing.h#L229-L244
        match index {
    ...
    fn rc_reg(&self) -> &Self::Reg {
        ...
        // https://github.com/torvalds/linux/blob/6063257da111c7639d020c5f15bfb37fb839d8b6/tools/lib/bpf/bpf_tracing.h#L248-L251
        &self.regs[0]
    }
    ...
    fn syscall_arg_reg_offset(index: usize) -> Option<usize> {
        ...
        // https://github.com/torvalds/linux/blob/6063257da111c7639d020c5f15bfb37fb839d8b6/arch/arm64/include/uapi/asm/ptrace.h#L88-L93
        // https://github.com/torvalds/linux/blob/6063257da111c7639d020c5f15bfb37fb839d8b6/arch/arm64/include/asm/ptrace.h#L59-L66
        // https://github.com/torvalds/linux/blob/6063257da111c7639d020c5f15bfb37fb839d8b6/tools/lib/bpf/bpf_tracing.h#L238-L246
        //
        ...
        // See https://github.com/torvalds/linux/commit/e057b94772328221405b067c3a85fe479b915dc8
        // and the fix in https://github.com/torvalds/linux/commit/5a87e8c7f3702eba8a1ed17431a807e01da3ae51
...
impl PtRegsLayout for pt_regs {
    ...
    fn arg_reg(&self, index: usize) -> Option<&Self::Reg> {
        ...
        // https://github.com/torvalds/linux/blob/6063257da111c7639d020c5f15bfb37fb839d8b6/arch/arm/include/uapi/asm/ptrace.h#L124-L152
        // https://github.com/torvalds/linux/blob/6063257da111c7639d020c5f15bfb37fb839d8b6/tools/lib/bpf/bpf_tracing.h#L198-L210
        match index {
    ...
    fn rc_reg(&self) -> &Self::Reg {
        ...
        // https://github.com/torvalds/linux/blob/6063257da111c7639d020c5f15bfb37fb839d8b6/tools/lib/bpf/bpf_tracing.h#L211-L214
        &self.uregs[0]
    }
}
...
impl PtRegsLayout for pt_regs {
    ...
    fn arg_reg(&self, index: usize) -> Option<&Self::Reg> {
        ...
        // https://github.com/torvalds/linux/blob/6063257da111c7639d020c5f15bfb37fb839d8b6/arch/loongarch/include/asm/ptrace.h#L20-L33
        // https://github.com/torvalds/linux/blob/6063257da111c7639d020c5f15bfb37fb839d8b6/tools/lib/bpf/bpf_tracing.h#L427-L444
        match index {
    ...
    fn rc_reg(&self) -> &Self::Reg {
        ...
        // https://github.com/torvalds/linux/blob/6063257da111c7639d020c5f15bfb37fb839d8b6/tools/lib/bpf/bpf_tracing.h#L445-L447
        &self.regs[4]
    }
}
...
impl PtRegsLayout for pt_regs {
    ...
    fn arg_reg(&self, index: usize) -> Option<&Self::Reg> {
        ...
        // https://github.com/torvalds/linux/blob/6063257da111c7639d020c5f15bfb37fb839d8b6/arch/mips/include/asm/ptrace.h#L28-L52
        // https://github.com/torvalds/linux/blob/6063257da111c7639d020c5f15bfb37fb839d8b6/tools/lib/bpf/bpf_tracing.h#L261-L275
        match index {
            0..=7 => Some(&self.regs[4 + index]),
            _ => None,
        }
    ...
    fn rc_reg(&self) -> &Self::Reg {
        ...
        // https://github.com/torvalds/linux/blob/6063257da111c7639d020c5f15bfb37fb839d8b6/tools/lib/bpf/bpf_tracing.h#L277-L279
        &self.regs[2]
    }
}
...
impl PtRegsLayout for pt_regs {
    ...
    fn arg_reg(&self, index: usize) -> Option<&Self::Reg> {
        ...
        // https://github.com/torvalds/linux/blob/6063257da111c7639d020c5f15bfb37fb839d8b6/arch/powerpc/include/asm/ptrace.h#L28-L56
        // https://github.com/torvalds/linux/blob/6063257da111c7639d020c5f15bfb37fb839d8b6/tools/lib/bpf/bpf_tracing.h#L290-L308
        match index {
    ...
    fn rc_reg(&self) -> &Self::Reg {
        ...
        // https://github.com/torvalds/linux/blob/6063257da111c7639d020c5f15bfb37fb839d8b6/tools/lib/bpf/bpf_tracing.h#L311-L314
        &self.gpr[3]
    }
}
...
impl PtRegsLayout for pt_regs {
    ...
    fn arg_reg(&self, index: usize) -> Option<&Self::Reg> {
        ...
        // https://github.com/torvalds/linux/blob/6063257da111c7639d020c5f15bfb37fb839d8b6/arch/riscv/include/asm/ptrace.h#L15-L55
        // https://github.com/torvalds/linux/blob/6063257da111c7639d020c5f15bfb37fb839d8b6/tools/lib/bpf/bpf_tracing.h#L360-L376
        match index {
            0 => Some(&self.a0),
            1 => Some(&self.a1),
            2 => Some(&self.a2),
    ...
    fn rc_reg(&self) -> &Self::Reg {
        ...
        // https://github.com/torvalds/linux/blob/6063257da111c7639d020c5f15bfb37fb839d8b6/tools/lib/bpf/bpf_tracing.h#L379-L382
        &self.a0
    }
}
...
impl PtRegsLayout for pt_regs {
    ...
    fn arg_reg(&self, index: usize) -> Option<&Self::Reg> {
        ...
        // https://github.com/torvalds/linux/blob/6063257da111c7639d020c5f15bfb37fb839d8b6/arch/s390/include/asm/ptrace.h#L111-L131
        // https://github.com/torvalds/linux/blob/6063257da111c7639d020c5f15bfb37fb839d8b6/tools/lib/bpf/bpf_tracing.h#L170-L181
        match index {
    ...
    fn rc_reg(&self) -> &Self::Reg {
        ...
        // https://github.com/torvalds/linux/blob/6063257da111c7639d020c5f15bfb37fb839d8b6/tools/lib/bpf/bpf_tracing.h#L186-L188
        &self.gprs[2]
    }
}
...
impl PtRegsLayout for pt_regs {
    ...
    fn arg_reg(&self, index: usize) -> Option<&Self::Reg> {
        ...
        // https://github.com/torvalds/linux/blob/6063257da111c7639d020c5f15bfb37fb839d8b6/arch/x86/include/asm/ptrace.h#L103-L155
        // https://github.com/torvalds/linux/blob/6063257da111c7639d020c5f15bfb37fb839d8b6/tools/lib/bpf/bpf_tracing.h#L134-L152
        match index {
            0 => Some(&self.rdi),
            1 => Some(&self.rsi),
            2 => Some(&self.rdx),
    ...
    fn rc_reg(&self) -> &Self::Reg {
        ...
        // https://github.com/torvalds/linux/blob/6063257da111c7639d020c5f15bfb37fb839d8b6/tools/lib/bpf/bpf_tracing.h#L148-L152
        &self.rax
    }
    ...
    fn syscall_arg_reg_offset(index: usize) -> Option<usize> {
        ...
        // return address).
        // https://github.com/torvalds/linux/blob/6063257da111c7639d020c5f15bfb37fb839d8b6/arch/x86/include/asm/ptrace.h#L103-L155
        // https://github.com/torvalds/linux/blob/6063257da111c7639d020c5f15bfb37fb839d8b6/tools/lib/bpf/bpf_tracing.h#L93-L102
        let offset = match index {
...
pub(crate) fn raw_tracepoint_arg<T: Argument>(ctx: &bpf_raw_tracepoint_args, n: usize) -> T {
    ...
    // https://github.com/torvalds/linux/blob/6063257da111c7639d020c5f15bfb37fb839d8b6/include/uapi/linux/bpf.h#L7231-L7233
