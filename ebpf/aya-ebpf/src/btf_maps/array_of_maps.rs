...
use crate::{
    bindings::bpf_map_type::BPF_MAP_TYPE_ARRAY_OF_MAPS, btf_maps::AyaBtfMapMarker,
...
/// enabling dynamic map selection at runtime. It's compatible with both
/// aya and libbpf loaders.
///
/// The struct layout matches what libbpf expects for BTF map definitions,
/// with an additional `values` field that creates a relocation for the
/// inner map type binding.
///
