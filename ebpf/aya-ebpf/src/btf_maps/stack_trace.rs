...
btf_map_def!(
    ...
    /// calling [`crate::programs::tracing::StackIdContext::get_stackid`] from
    /// a tracing program; read the resulting trace from user space via
    ...
    /// model. Calling
    /// [`crate::programs::tracing::StackIdContext::get_stackid`] on a
