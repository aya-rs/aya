...
mod tests {
    ...
    #[test_case("uprobe/foo", UserProbeKind::Entry, false, false; "uprobe_plain")]
    #[test_case("uprobe.s/foo", UserProbeKind::Entry, true, false; "uprobe_sleepable")]
    #[test_case("uprobe.multi/foo", UserProbeKind::Entry, false, true; "uprobe_multi")]
    #[test_case("uprobe.multi.s/foo", UserProbeKind::Entry, true, true; "uprobe_multi_sleepable")]
    #[test_case("uretprobe/foo", UserProbeKind::Return, false, false; "uretprobe_plain")]
    #[test_case("uretprobe.s/foo", UserProbeKind::Return, true, false; "uretprobe_sleepable")]
    #[test_case("uretprobe.multi/foo", UserProbeKind::Return, false, true; "uretprobe_multi")]
    #[test_case("uretprobe.multi.s/foo", UserProbeKind::Return, true, true; "uretprobe_multi_sleepable")]
    fn test_parse_section_user_probe(
        ...
        let (actual_sleepable, actual_multi) = match (kind, program.section) {
            (UserProbeKind::Entry, ProgramSection::UProbe { sleepable, multi })
            | (UserProbeKind::Return, ProgramSection::URetProbe { sleepable, multi }) => {
                (sleepable, multi)
            }
            (_, section) => panic!("unexpected section: {section:?}"),
        };
