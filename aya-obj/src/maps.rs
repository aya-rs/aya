...
impl Map {
    ...
    ///
    /// This is primarily used by `aya::maps::HashMap::create()` to build
    /// standalone maps for use as inner maps in map-of-maps types.
    #[doc(hidden)]
    ...
    ///
    /// This is primarily used by `aya::maps::Array::create()` to build
    /// standalone maps for use as inner maps in map-of-maps types.
    #[doc(hidden)]
