...
/// BPF loader.
/// <https://github.com/iproute2/iproute2/blob/v7.2.0/include/bpf_elf.h#L32-L42>
#[repr(C)]
#[derive(Copy, Clone, Debug, Default, PartialEq, Eq)]
pub struct bpf_map_def {
    ...
    /// Id
    pub id: u32,
    /// Pinning mode: `PIN_OBJECT_NS`, `PIN_GLOBAL_NS`, or any other value,
    /// which tc looks up in its custom pinning table. Aya supports none of
    /// them, so parsing rejects a set value with
    /// [`ParseError::UnsupportedLegacyPinning`](crate::ParseError::UnsupportedLegacyPinning).
    /// <https://github.com/iproute2/iproute2/blob/v7.2.0/include/bpf_elf.h#L27-L29>
    /// <https://github.com/iproute2/iproute2/blob/v7.2.0/lib/bpf_legacy.c#L1359-L1371>
    ...
    /// <https://github.com/iproute2/iproute2/blob/v7.2.0/lib/bpf_legacy.c#L1799-L1822>
