...
impl RingBuf {
    ...
    /// function will be compiled to a panic and depending on your panic_handler, may silently make
    /// your eBPF program fail to load or have undefined behavior.
    ///
    /// TODO(https://github.com/rust-lang/rust/issues/76560): Always use `const_assert` to ensure
    /// the alignment is correct. This is not currently possible because the underlying
    /// `const_generic_exprs` language feature is still incomplete.
