...
#[btf_map]
static HASH_BTF: BtfHashMap<u32, u64, 16> = BtfHashMap::new();

#[btf_map]
static LRU_HASH_BTF: BtfLruHashMap<u32, u64, 16> = BtfLruHashMap::new();

#[btf_map]
static PER_CPU_HASH_BTF: BtfPerCpuHashMap<u32, u64, 16> = BtfPerCpuHashMap::new();

#[btf_map]
static LRU_PER_CPU_HASH_BTF: BtfLruPerCpuHashMap<u32, u64, 16> = BtfLruPerCpuHashMap::new();

#[map]
static RESULT_LEGACY: Array<u64> = Array::<u64>::with_max_entries(1, 0);

#[map]
static HASH_LEGACY: HashMap<u32, u64> = HashMap::with_max_entries(16, 0);

#[map]
static LRU_HASH_LEGACY: LruHashMap<u32, u64> = LruHashMap::with_max_entries(16, 0);

#[map]
static PER_CPU_HASH_LEGACY: PerCpuHashMap<u32, u64> = PerCpuHashMap::with_max_entries(16, 0);
