...
use integration_common::syscall_args::TestResult;
#[cfg(any(bpf_target_arch = "aarch64", bpf_target_arch = "x86_64"))]
use integration_common::syscall_args::{RAN, RESULT_INDEX};
#[cfg(not(test))]
...
#[kprobe]
fn syscall_args_splice(_ctx: ProbeContext) -> u32 {
    let _tgid = TARGET_TGID.load();
    0
}
