...
// Waiting for this number of events to be reached can take a long time on the VMs used in CI, which
// implies we are experiencing a low rate of scheduler events. Lowering this speeds up the tests.
#[cfg(target_env = "musl")]
