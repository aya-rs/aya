...
const OPTIONAL_INDEX: u32 = 0;
const UNKNOWN_LINUX_INDEX: u32 = 1;
const CHAR_VALUE_INDEX: u32 = 2;
const BOOL_VALUE_INDEX: u32 = 3;
const TRISTATE_ENUM_INDEX: u32 = 4;
const TRUNCATED_STRING_INDEX: u32 = 5;
...
fn attach_uprobe(mut bpf: Ebpf, program_name: &str, symbol: &str) -> Ebpf {
    ...
    prog.load().unwrap();
    prog.attach([symbol], "/proc/self/exe", UProbeScope::CallingProcess)
        .unwrap();
    bpf
}
