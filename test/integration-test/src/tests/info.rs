...
fn list_loaded_maps() {
    ...
    let maps: Vec<_> = maps
        .filter_map(|result| match result {
            ...
            // resulting ENOENT:
            // https://github.com/torvalds/linux/blob/b15dc4170c6317731c00fa8fe7d4d99a0a04c83c/kernel/bpf/syscall.c#L3184-L3207
            // https://github.com/torvalds/linux/blob/b95f03f04d475aa6719d15a636ddf32222d55657/tools/testing/selftests/bpf/prog_tests/bpf_obj_id.c#L205-L218
            // https://github.com/libbpf/bpftool/blob/5730b384d39ee68a39c6e506c33362d3497f568f/src/map.c#L703-L719
