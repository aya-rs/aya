...
use crate::{
    ...
    programs::{
        ...
        perf_attach::{
            PerfLinkIdInner, PerfLinkInner, PerfLinkLeaf, perf_attach, perf_attach_debugfs,
        },
    },
    sys::{
...
pub enum ProgramError {
    ...
    /// One or more perf-style links failed to detach.
    #[error(transparent)]
    PerfLinkDetachError(#[from] perf_attach::PerfLinkDetachError),
