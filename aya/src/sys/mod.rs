...
/// It provides [`override_syscall`] to intercept
...
pub mod test_utils {
    ...
    pub use super::{PerfEventIoctlRequest, SysResult, Syscall, fake::override_syscall};
...
///
/// Pattern-match on this in your [`override_syscall`] handler.
pub enum Syscall<'a> {
    /// A BPF syscall.
    Ebpf {
        /// The BPF command.
