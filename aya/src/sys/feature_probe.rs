...
pub fn is_map_supported(map_type: MapType) -> Result<bool, SyscallError> {
    ...
    let (key_size, value_size, max_entries) = match map_type {
        ...
        | MapType::PerCpuHash           // https://github.com/torvalds/linux/blob/2dcd0af56/kernel/bpf/hashtab.c#L726
        | MapType::LruHash              // https://github.com/torvalds/linux/blob/c470abd4f/kernel/bpf/hashtab.c#L1032
        | MapType::LruPerCpuHash        // https://github.com/torvalds/linux/blob/c470abd4f/kernel/bpf/hashtab.c#L1133
            => (1, 1, 1),
        ...
        | MapType::ArrayOfMaps          // https://github.com/torvalds/linux/blob/6f7da2904/kernel/bpf/arraymap.c#L595
        | MapType::DevMap               // https://github.com/torvalds/linux/blob/bebc6082d/kernel/bpf/devmap.c#L360
        | MapType::SockMap              // https://github.com/torvalds/linux/blob/bebc6082d/kernel/bpf/sockmap.c#L874
        | MapType::CpuMap               // https://github.com/torvalds/linux/blob/d8a5b8056/kernel/bpf/cpumap.c#L589
        ...
        | MapType::BloomFilter          // https://github.com/torvalds/linux/blob/df0cc57e0/kernel/bpf/bloom_filter.c#L193
            => (0, 1, 1),
        MapType::SkStorage              // https://github.com/torvalds/linux/blob/0ecfebd2b/net/core/bpf_sk_storage.c#L779
        ...
        // https://github.com/torvalds/linux/blob/bcf876870/kernel/bpf/ringbuf.c#L160
    ...
    match map_type {
        ...
        //
        // https://github.com/torvalds/linux/blob/a351e9b9f/kernel/bpf/lpm_trie.c#L419
        ...
        | MapType::CgrpStorage => {
            ...
            // - sk_storage: https://github.com/torvalds/linux/blob/0ecfebd2b/net/core/bpf_sk_storage.c#L604
            // - inode_storage: https://github.com/torvalds/linux/blob/2c85ebc57/kernel/bpf/bpf_local_storage.c#L525
            // - task_storage: https://github.com/torvalds/linux/blob/f40ddce88/kernel/bpf/bpf_local_storage.c#L527
            // - cgrp_storage: https://github.com/torvalds/linux/blob/c9c3395d5/kernel/bpf/bpf_local_storage.c#L539
            u.map_flags = BPF_F_NO_PREALLOC;
            // Intentionally trigger `EBADF` from `btf_get_by_fd()`[0].
            //
            // [0] https://github.com/torvalds/linux/blob/0ecfebd2b/kernel/bpf/btf.c#L3428
            u.btf_fd = u32::MAX;
            u.btf_key_type_id = 1;
        ...
        //
        // [0] https://github.com/torvalds/linux/blob/a38297e3f/kernel/bpf/arena.c#L103
    ...
    match io_error.raw_os_error() {
        ...
        // Otherwise, negative support produces `EINVAL`, meaning it was immediately rejected.
        //
        // [0] https://github.com/torvalds/linux/blob/7111951b8/kernel/bpf/bpf_struct_ops.c#L557
